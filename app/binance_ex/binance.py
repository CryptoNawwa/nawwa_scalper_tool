...
from binance_ex.transformers.transform_symbol_info import transform_symbol_info
...
class Binance(Exchange):
    ...
    def _listen_user_position(self):
        ...
        ret = self.binance_ws.start_margin_socket(self._callback_start_user_socket)
